...
class OpenlistUtils(metaclass=Singleton):
    """
    Openlist 相关工具
    """
    ...
    def sign(secret_key: str, data: str) -> str:
        """
        计算 Openlist 签名
        :param secret_key: Openlist 签名 Token
        :param data: Openlist 文件绝对路径（未编码）
        """
    ...
    def structure2dict(text: str) -> dict:
        """
        将能够被 Openlist 地址树识别的文本转换为字典，支持键值对中包含两个冒号的情况
        """
